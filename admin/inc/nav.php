  ...
  <ul class="navbar-nav ml-auto">
    ...
    <li class="nav-item dropdown mt-2">
        ...
        <div class="dropdown-menu">
          <a class="dropdown-item" href="kategori.php">view Categories </a>
          <a class="dropdown-item" href="addKategori.php">Add Categories</a> 
        </div>
      </li>
      ...
      <li class="nav-item dropdown mt-2">
        ...
        <div class="dropdown-menu">
          <a class="dropdown-item" href="buku.php">view Products </a>
          <a class="dropdown-item" href="addBuku.php">Add Products</a> 
        </div>
      </li>
      ...
      <li class="nav-item dropdown mt-2">
        ...
        <div class="dropdown-menu">
          <a class="dropdown-item" href="cekAkun.php">Cek Akun </a>
